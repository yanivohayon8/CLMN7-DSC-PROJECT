...
class CreateBlocks:
    ...
    def partion(self,method="sliding_window",
                ...
                video_path=None,target_path=None,video_name='',wanted_frequency=15,wanted_similarity_percent = 75):
        ...
        if method == 'text_changing':
            return self.partion_by_slides_text_changes(video_path, target_path, wanted_frequency, video_name, wanted_similarity_percent)
    ...
    def partion_by_slides_text_changes(self, video_path, target_path, wanted_frequency, video_name, wanted_similarity_percent):
        if os.path.isfile(video_path) is False:
            raise Exception('path %s was not found. (For more details +972-54378975893)' % (video_path))
        slices_seconds = get_time_titles_changed(video_path, target_path, wanted_frequency, video_name, wanted_similarity_percent)
