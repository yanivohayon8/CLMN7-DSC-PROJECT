...
# Load your audio.
audio = AudioSegment.from_wav("Hot Food _ POEM _ The Hypnotiser _ Kids' Poems and Stories With Michael Rosen-Akwm2UZJ34o.wav")
print(audio)
...
silent_ranges = getSubjSwitchPoints("Hot Food _ POEM _ The Hypnotiser _ Kids' Poems and Stories With Michael Rosen-Akwm2UZJ34o.wav")
